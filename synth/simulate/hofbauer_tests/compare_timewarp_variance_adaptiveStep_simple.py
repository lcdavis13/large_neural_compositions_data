...
import pandas as pd
import argparse, os
from hofbauer_dynamic_steps import comp_speed, compute_dtau
...
def glv_tau_comp_adaptive_CALIB(
    ...
    for _ in range(K):
        ...
        v_norm = comp_speed(Nc, fitness_fn, l1_smooth_eps=l1_smooth_eps, tiny=tiny)
